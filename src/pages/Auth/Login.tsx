...
const Login = () => {
    ...
    const onSubmitHandler = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        axios
            .get(`${process.env.VITE_API_URL}/login?${params}`)
                ...
                <div className="w-full border-stroke xl:w-1/2 xl:border-l-2">
                    <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                        <h2 className="mb-9 text-2xl font-bold text-black">
                            Sign In to Rep Connect
                        </h2>
                        <form onSubmit={(event: React.FormEvent<HTMLFormElement>) => onSubmitHandler(event)} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                            <div className="mb-4">
                            ...
                            <div className="mb-6">
                                <label className="mb-2.5 block text-black" htmlFor="password">
                                    Password
                                </label>
                                <input
                                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter"
