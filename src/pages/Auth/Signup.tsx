            ...
            <div className="flex flex-wrap items-center">
                <div className="hidden w-full xl:block xl:w-1/2">
                    <div className="py-17.5 px-26 text-center">
                        <Link className="mb-5.5 inline-block font-semibold text-3xl pt-1" to="/">
                            Rep Connect
                        </Link>
                ...
                <div className="w-full border-stroke xl:w-1/2 xl:border-l-2">
                    <div className="w-full p-2 sm:p-12.5 xl:p-17.5">
                        <h4 className="flex font-bold text-black sm:text-title-md pl-6">
                            <span className='2xsm:hidden md:block'>Sign Up to</span> <span className='pl-2'>Rep Connect</span>
                        </h4>

                        <form className="bg-white rounded-sm shadow-default px-8 pt-6 pb-8 mb-4">
                            <div className="mb-4">
                                <input
                            ...
                            <div className="mb-4">
                                <input
                                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter"
                                    id="username" type="text" placeholder="Email Address" />
                            </div>
                            <div className="mb-4">
                                <input
                                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter"
