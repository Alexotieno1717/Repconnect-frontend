...
const DropdownUser = () => {
    ...
    return (
        ...
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs text-black dark:text-white">Cardiologist</span>
        </span>
        ...
        <span className="h-12 w-12 rounded-full">
          <img src={UserOne} alt="User" className='rounded-full' />
            ...
            <div
                ...
                className={`absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default text-black dark:text-white dark:border-strokedark dark:bg-boxdark ${
